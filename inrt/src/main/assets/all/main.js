...
function kuaishou(){
    try {
        var kuaishouJS = require('kuaishou.js');
...
function juKanDianFunc(){
    try {
        var juKanDian = require('jukandian.js');
...
function quTouTiaoFunc(){
    try {
        var quTouTiao = require('qutoutiao.js');
